...
def create_mds_p(n, t):
    ...
    while True:
        flag = True
        # Tom's Note: TODO
        rand_list = [F(i) for i in range(_sage_const_0 , _sage_const_2 *t)]
